...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("xenios://"))
    {
        uri.replace(0, 12, "xenios:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Xenios.lnk";
}
...
{
    return GetAutostartDir() / "xenios.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Xenios-Qt") + " " + tr("version") + " " +
